...
import {  GameConfig, Globals } from "../Globals";
...
export class levelGenerator extends Scene {
    ...
    constructor() {
        ...
        levelVariables.unlocked = GameConfig.currentLevel;
        ...
        this.mainContainer.addChild(levelsText);

        this.divContainer = new divContainer();
        this.divContainer.y = 250;
        this.mainContainer.addChild(this.divContainer);
    ...
    cancelButton() {
        ...
        cancel.on("pointerdown", () => {
            ...
            //     onCancelCallback();
            // }
            SceneManager.instance!.start(new GameMenuScene());
        })
        cancel.on("pointerup", () => {
            cancel.alpha = 1;
        })
        ...
        this.mainContainer.addChild(cancel);
    }
    ...
    movingBtns() {
        ...
        this.mainContainer.addChild(leftBtn);
        ...
        this.mainContainer.addChild(RightBtn);
